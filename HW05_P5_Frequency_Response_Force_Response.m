...
z1 = 0;
xp_1 = 1./sqrt((1-r.^2).^2+(2*z1*r).^2);

z2 = 0.06;
xp_2 = 1./sqrt((1-r.^2).^2+(2*z2*r).^2);

z3 = 0.1;
xp_3 = 1./sqrt((1-r.^2).^2+(2*z3*r).^2);

z4 = 0.2;
xp_4 = 1./sqrt((1-r.^2).^2+(2*z4*r).^2);

z5 = 0.4;
xp_5 = 1./sqrt((1-r.^2).^2+(2*z5*r).^2);

z6 = 1;
xp_6 = 1./sqrt((1-r.^2).^2+(2*z6*r).^2);
...
title('Force Response'); xlabel('r','FontSize',20); ylabel('$\frac{KX}{F}$    ','Interpreter','latex','rotation',0,'FontSize',25)
